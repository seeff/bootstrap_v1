...
<form id="fc_form_checkout" method="post" action="https://{{ store_domain }}{{ post_url }}" onsubmit="return false;">
    ...
    <fieldset id="fc_login_register">
        ...
        {% endif %}
            ...
            <div id="fc_continue" class="row fc_row_actions"><a href="#" onclick="FC.checkout.checkLogin(); return false;" class="fc_link_nav fc_link_forward">{{ lang.checkout_continue|raw }}</a></div>
                ...
                <fieldset id="fc_customer_billing">
                    ...
                    <div class="fc_inner">
                        <ol id="fc_customer_billing_list">
                            <li class="row fc_row_select fc_foxycomplete fc_customer_country_name">
                                ...
                                <input value="{{ (country_code == '') ? country_name : country_code }}" type="text" style="display:none;" class="fc_foxycomplete_input form-control fc_text_long fc_required fc_location" id="customer_country_name" name="customer_country_name">
                            ...
                            <li class="row fc_customer_company">
                                <label class="fc_pre" for="customer_company">{{ lang.checkout_company|raw }}</label>
                                <input type="text" value="{{ company }}" class="form-control fc_text_long" id="customer_company" name="customer_company" autocomplete="billing organization">
                                <label style="display:none;" class="fc_error" for="customer_company">{{ lang.checkout_error_company|raw }}</label>
                            </li>
                            <li class="row fc_customer_address1">
                            ...
                            <li class="row fc_customer_address2">
                            ...
                            <li class="row fc_row_select fc_foxycomplete fc_customer_state_name">
                                ...
                                <select class="form-control fc_text_long fc_required fc_location" data-default-value="{{ region_code }}" id="customer_state" name="customer_state">
                                {{ region_options|raw }}
                                </select>
                            ...
                            <li class="row fc_customer_phone">
                                <label class="fc_pre" for="customer_phone">{{ lang.checkout_phone|raw }}</label>
                                <input type="text" value="{{ phone }}" class="form-control fc_text_long" id="customer_phone" name="customer_phone" autocomplete="billing tel">
                ...
                <fieldset id="fc_shipping_address">
                    ...
                    <div class="fc_inner">
                        <ol id="fc_address_shipping_list">
                            <li class="row fc_row_select fc_foxycomplete fc_shipping_country_name">
                                ...
                                <input value="{{ (shipping_country_code == '') ? shipping_country_name : shipping_country_code }}" type="text" style="display:none;" class="fc_foxycomplete_input form-control fc_text_long fc_required fc_location" id="shipping_country_name" name="shipping_country_name">
                            ...
                            <li class="row fc_shipping_company">
                                <label class="fc_pre" for="shipping_company">{{ lang.checkout_company|raw }}</label>
                                <input type="text" value="{{ shipping_company }}" class="form-control fc_text_long" id="shipping_company" name="shipping_company" autocomplete="shipping organization">
                            ...
                            <li class="row fc_row_select fc_foxycomplete fc_shipping_state_name">
                                ...
                                <select class="form-control fc_text_long fc_required fc_location" data-default-value="{{ shipping_region_code }}" id="shipping_state" name="shipping_state">
                                {{ shipping_region_options|raw }}
                                </select>
                                <input value="{{ (shipping_region_code == '') ? shipping_region_name : shipping_region_code }}" type="text" style="display:none;" class="fc_foxycomplete_input form-control fc_text_long fc_required fc_location" id="shipping_state_name" name="shipping_state_name">
                            ...
                            <li class="row fc_shipping_phone">
                                <label class="fc_pre" for="shipping_phone">{{ lang.checkout_phone|raw }}</label>
                                <input type="text" value="{{ shipping_phone }}" class="form-control fc_text_long" id="shipping_phone" name="shipping_phone" autocomplete="shipping tel">
                    ...
                    <fieldset id="fc_shipto_{{ multiship.number }}">
                        ...
                        <div class="fc_inner fc_shipto_entry" id="fc_shipto_{{ multiship.number }}_entry">
                            <ol id="fc_shipto_{{ multiship.number }}_list">
                                ...
                                <li class="row fc_row_select fc_foxycomplete fc_shipto_{{ multiship.number }}_country_name">
                                    ...
                                    <input value="{{ (multiship.country_code == '') ? multiship.country_name : multiship.country_code }}" type="text" style="display:none;" class="fc_foxycomplete_input form-control fc_text_long fc_required fc_location" id="shipto_{{ multiship.number }}_country_name" name="shipto_{{ multiship.number }}_country_name">
                                    <label style="display:none;" class="fc_error" for="shipto_{{ multiship.number }}_country_name">{{ lang.checkout_error_country|raw }}</label>
                                </li>
                                <li class="row fc_shipto_{{ multiship.number }}_first_name">
                                    <label class="fc_pre" for="shipto_{{ multiship.number }}_first_name">{{ lang.checkout_first_name|raw }}<span class="fc_ast">*</span></label>
                                    <input type="text" value="{{ multiship.first_name }}" class="form-control fc_text_long fc_required" id="shipto_{{ multiship.number }}_first_name" name="shipto_{{ multiship.number }}_first_name" autocomplete="section-{{ multiship.number }} shipping given-name">
                                ...
                                <li class="row fc_shipto_{{ multiship.number }}_last_name">
                                    <label class="fc_pre" for="shipto_{{ multiship.number }}_last_name">{{ lang.checkout_last_name|raw }}<span class="fc_ast">*</span></label>
                                    <input type="text" value="{{ multiship.last_name }}" class="form-control fc_text_long fc_required" id="shipto_{{ multiship.number }}_last_name" name="shipto_{{ multiship.number }}_last_name" autocomplete="section-{{ multiship.number }} shipping family-name">
                                    <label style="display:none;" class="fc_error" for="shipto_{{ multiship.number }}_last_name">{{ lang.checkout_error_last_name|raw }}</label>
                                </li>
                                <li class="row fc_shipto_{{ multiship.number }}_company">
                                    <label class="fc_pre" for="shipto_{{ multiship.number }}_company">{{ lang.checkout_company|raw }}</label>
                                    <input type="text" value="{{ multiship.company }}" class="form-control fc_text_long" id="shipto_{{ multiship.number }}_company" name="shipto_{{ multiship.number }}_company" autocomplete="section-{{ multiship.number }} shipping organization">
                                    <label style="display:none;" class="fc_error" for="shipto_{{ multiship.number }}_company">{{ lang.checkout_error_company|raw }}</label>
                                </li>
                                <li class="row fc_shipto_{{ multiship.number }}_address1">
                                    <label class="fc_pre" for="shipto_{{ multiship.number }}_address1">{{ lang.checkout_address1|raw }}<span class="fc_ast">*</span></label>
                                    <input type="text" value="{{ multiship.address1 }}" class="form-control fc_text_long fc_required" id="shipto_{{ multiship.number }}_address1" name="shipto_{{ multiship.number }}_address1" autocomplete="section-{{ multiship.number }} shipping address-line1">
                                    <label style="display:none;" class="fc_error" for="shipto_{{ multiship.number }}_address1">{{ lang.checkout_error_address1|raw }}</label>
                                </li>
                                <li class="row fc_shipto_{{ multiship.number }}_address2">
                                    <label class="fc_pre" for="shipto_{{ multiship.number }}_address2">{{ lang.checkout_address2|raw }}</label>
                                    <input type="text" value="{{ multiship.address2 }}" class="form-control fc_text_long" id="shipto_{{ multiship.number }}_address2" name="shipto_{{ multiship.number }}_address2" autocomplete="section-{{ multiship.number }} shipping address-line2">
                                </li>
                                <li class="row fc_shipto_{{ multiship.number }}_city">
                                    <label class="fc_pre" for="shipto_{{ multiship.number }}_city">{{ lang.checkout_city|raw }}<span class="fc_ast">*</span></label>
                                    <input type="text" value="{{ multiship.city }}" class="form-control fc_text_long fc_required" id="shipto_{{ multiship.number }}_city" name="shipto_{{ multiship.number }}_city" autocomplete="section-{{ multiship.number }} shipping locality">
                                    <label style="display:none;" class="fc_error" for="shipto_{{ multiship.number }}_city">{{ lang.checkout_error_city|raw }}</label>
                                </li>
                                <li class="row fc_row_select fc_foxycomplete fc_shipto_{{ multiship.number }}_state_name">
                                    <label class="fc_pre" for="shipto_{{ multiship.number }}_state_name">{{ lang.checkout_state|raw }}<span class="fc_ast">*</span></label>
                                    <select class="form-control fc_text_long fc_required fc_location" data-default-value="{{ multiship.region_code }}" id="shipto_{{ multiship.number }}_state" name="shipto_{{ multiship.number }}_state" style="display: none;">
                                    {{ multiship.region_options|raw }}
                                    </select>
                                    <input value="{{ (multiship.region_code == '') ? multiship.region_name : multiship.region_code }}" type="text" class="fc_foxycomplete_input form-control fc_text_long fc_required fc_location" id="shipto_{{ multiship.number }}_state_name" name="shipto_{{ multiship.number }}_state_name">
                                    <label style="display:none;" class="fc_error" for="shipto_{{ multiship.number }}_state_name">{{ lang.checkout_error_state|raw }}</label>
                                </li>
                                <li class="row fc_shipto_{{ multiship.number }}_postal_code">
                                    <label class="fc_pre" for="shipto_{{ multiship.number }}_postal_code">{{ lang.checkout_postal_code|raw }}<span class="fc_ast">*</span></label>
                                    <input type="text" value="{{ multiship.postal_code }}" class="form-control fc_text_short fc_required" id="shipto_{{ multiship.number }}_postal_code" name="shipto_{{ multiship.number }}_postal_code" autocomplete="section-{{ multiship.number }} shipping postal-code">
