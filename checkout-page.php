 ...
 -->    <fieldset id="fc_login_register">
        ...
        {% endif %}
                ...
                <div id="li_customer_email_password" class="form-group row text-right" style="display:none">
                    <label for="fc_email_password"><a id="fc_email_password" class="btn btn-danger" href="javascript:;" onclick="FC.checkout.emailPassword()">{{ lang.checkout_email_my_password|raw }}</a></label>
                </div>
                <div id="li_customer_new_password" class="form-group row text-right" style="display:none">
                    <label for="fc_new_password"><a id="fc_new_password" class="btn btn-danger" href="javascript:;" onclick="FC.checkout.newPassword()">{{ lang.checkout_change_my_password|raw }}</a></label>
                </div>
            </div>
...
{% endif %}
            ...
            {% endif %}
                <th{{ css_styles.background }} id="fc_cart_head_item"><span></span></th>
            </tr>
{% if not for_email %}
        </thead>
{% endif %}
