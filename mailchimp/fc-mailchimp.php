...
$MailChimp_Auth = array(
	'apikey' => '2f1af655ddcc518c5b24006a1e29e54d-us5'		// Using an API key is now the preferred method of connecting to MailChimp.
...
$Send_Confirmation = false;      // If true, MailChimp will send a confirmation email to the customer.

$List_Name = 'Foxycart Checkout List'; // The exact name of your mailing list.  No List ID required, we'll look it up.

$key = 'nEYCNBtSNIhrLyfRvrZNAMZqhb2YPfR7JJznbX7PweacGjY7BNP6vEqCGirq';
