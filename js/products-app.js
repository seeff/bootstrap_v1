...
function padWithZero(value) {
    ...
    jQuery("input[id=12months]").val("Twelve%20Months%20Subscription&price=144.00&code=12m&2:name=Twelve%20Months%20Subscription%20Free&2:price=0.00&2:sub_frequency=1m&2:code=free&2:sub_enddate=" + year + month + day);
})